...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{url('/home')}}">
            ...
            <div class="sidebar-brand-text mx-3">Gestionnaire</div>
        </a>
        ...
        <li class="nav-item">
            ...
            <div id="collapseClient" class="collapse" aria-labelledby="headingClient" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="/AddClient">Ajouter un client</a>
                    <a class="collapse-item" href="/ViewClient">Lister les clients</a>

                </div>
            </div>
        </li>
        <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseFourn" aria-expanded="true" aria-controls="collapseFourn">
            ...
            <div id="collapseFourn" class="collapse" aria-labelledby="headingFourn" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="/AddFournisseur">Ajouter un fournisseur</a>
                    <a class="collapse-item" href="/ViewFournisseur">Lister les fournisseurs</a>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <img class="img-profile rounded-circle" src="{{asset("img/user.jfif")}}">
                        </a>
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; BC DEV</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
