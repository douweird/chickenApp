...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Modifier Client</h1>
    </div>

    <form method="post" action="{{ url('/ModifyClient/' . $credit->id) }}">
        {{ csrf_field() }}
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="amount" placeholder="Montant ... " name="phone"
                    value="{{ $credit->phone }}" />
            </div>
        </div>
