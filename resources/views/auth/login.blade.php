                            ...
                            <div class="p-5">
                                ...
                                <form class="user" role="form" method="POST" action="/login">
                                    ...
                                    <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}" >
                                        <input type="email" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder=" Adresse Email..." value="{{ old('email') }}" name="email">
                                        @if ($errors->has('email'))
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox small">
                                            ...
                                            <label class="custom-control-label" for="customCheck">Mémoriser moi</label>
                                        </div>
                                    </div>
